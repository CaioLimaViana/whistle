...
function setup_menu(){
    document.querySelectorAll("nav > ul > li > button").forEach(button =>{
        button.addEventListener("click",(event)=>{
            ...
            if(form) Array.from(form.elements).forEach(element=>element.value = "");
    ...
    document.querySelectorAll("form > fieldset > div > button").forEach((button)=>{
        button.addEventListener("click",(event)=>{
            ...
            Array.from(form.elements).forEach((element)=>{
                ...
                if(element.type !== "button" && element.type !== "checkbox") obj[element.name] = element.value;
            });
